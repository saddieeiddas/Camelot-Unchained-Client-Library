...
declare module 'camelot-unchained' {
    /**
      ...
      */
    import CoreSettings from '__camelot-unchained/CoreSettings';
    import clientInterface from '__camelot-unchained/clientInterface';
    import client from '__camelot-unchained/client';
    import abilityTags from '__camelot-unchained/constants/abilityConstants/abilityTags';
    import archetype from '__camelot-unchained/constants/archetype';
    import buildUIMode from '__camelot-unchained/constants/buildUIMode';
    import channelId from '__camelot-unchained/constants/channelId';
    import dxKeyCodes from '__camelot-unchained/constants/dxKeyCodes';
    import emotes from '__camelot-unchained/constants/emotes';
    import jsKeyCodes from '__camelot-unchained/constants/jsKeyCodes';
    import jsToDXKeyCodeMap from '__camelot-unchained/constants/jsToDXKeyCodeMap';
    import race from '__camelot-unchained/constants/race';
    import soundEvents from '__camelot-unchained/constants/soundEvents';
    import tagConstraintType from '__camelot-unchained/constants/tagConstraintType';
    import tags from '__camelot-unchained/constants/tags';
    import Ability from '__camelot-unchained/classes/Ability';
    import Combatant from '__camelot-unchained/classes/Combatant';
    ...
    export { CoreSettings, clientInterface, client, abilityTags, archetype, buildUIMode, channelId, dxKeyCodes, emotes, jsKeyCodes, jsToDXKeyCodeMap, race, soundEvents, tagConstraintType, tags, Ability, Combatant, Player, Character, ControlGame, Injury, Population, events, stores, components };
}
...
declare module '__camelot-unchained/clientInterface' {
    /**
      * This Source Code Form is subject to the terms of the Mozilla Public
      * License, v. 2.0. If a copy of the MPL was not distributed with this
      * file, You can obtain one at http://mozilla.org/MPL/2.0/.
...
declare module '__camelot-unchained/client' {
    /**
      * This Source Code Form is subject to the terms of the Mozilla Public
      * License, v. 2.0. If a copy of the MPL was not distributed with this
      * file, You can obtain one at http://mozilla.org/MPL/2.0/.
...
declare module '__camelot-unchained/constants/abilityConstants/abilityTags' {
    /**
      * This Source Code Form is subject to the terms of the Mozilla Public
      * License, v. 2.0. If a copy of the MPL was not distributed with this
      * file, You can obtain one at http//mozilla.org/MPL/2.0/.
...
declare module '__camelot-unchained/constants/archetype' {
    /**
      * This Source Code Form is subject to the terms of the Mozilla Public
      * License, v. 2.0. If a copy of the MPL was not distributed with this
      * file, You can obtain one at http://mozilla.org/MPL/2.0/.
...
declare module '__camelot-unchained/constants/buildUIMode' {
    /**
      * This Source Code Form is subject to the terms of the Mozilla Public
      * License, v. 2.0. If a copy of the MPL was not distributed with this
      * file, You can obtain one at http://mozilla.org/MPL/2.0/.
...
declare module '__camelot-unchained/constants/channelId' {
    /**
      * This Source Code Form is subject to the terms of the Mozilla Public
      * License, v. 2.0. If a copy of the MPL was not distributed with this
      * file, You can obtain one at http://mozilla.org/MPL/2.0/.
...
declare module '__camelot-unchained/constants/dxKeyCodes' {
    /**
      * This Source Code Form is subject to the terms of the Mozilla Public
      * License, v. 2.0. If a copy of the MPL was not distributed with this
      * file, You can obtain one at http://mozilla.org/MPL/2.0/.
...
declare module '__camelot-unchained/constants/emotes' {
    /**
      * This Source Code Form is subject to the terms of the Mozilla Public
      * License, v. 2.0. If a copy of the MPL was not distributed with this
      * file, You can obtain one at http://mozilla.org/MPL/2.0/.
...
declare module '__camelot-unchained/constants/jsKeyCodes' {
    /**
      * This Source Code Form is subject to the terms of the Mozilla Public
      * License, v. 2.0. If a copy of the MPL was not distributed with this
      * file, You can obtain one at http://mozilla.org/MPL/2.0/.
...
declare module '__camelot-unchained/constants/jsToDXKeyCodeMap' {
    /**
      * This Source Code Form is subject to the terms of the Mozilla Public
      * License, v. 2.0. If a copy of the MPL was not distributed with this
      * file, You can obtain one at http://mozilla.org/MPL/2.0/.
...
declare module '__camelot-unchained/constants/race' {
    /**
      * This Source Code Form is subject to the terms of the Mozilla Public
      * License, v. 2.0. If a copy of the MPL was not distributed with this
      * file, You can obtain one at http://mozilla.org/MPL/2.0/.
...
declare module '__camelot-unchained/constants/soundEvents' {
    /**
      * This Source Code Form is subject to the terms of the Mozilla Public
      * License, v. 2.0. If a copy of the MPL was not distributed with this
      * file, You can obtain one at http://mozilla.org/MPL/2.0/.
...
declare module '__camelot-unchained/constants/tagConstraintType' {
    /**
      * This Source Code Form is subject to the terms of the Mozilla Public
      * License, v. 2.0. If a copy of the MPL was not distributed with this
      * file, You can obtain one at http://mozilla.org/MPL/2.0/.
...
declare module '__camelot-unchained/constants/tags' {
    /**
...
declare module '__camelot-unchained/classes/Combatant' {
    /**
        * This Source Code Form is subject to the terms of the Mozilla Public
        * License, v. 2.0. If a copy of the MPL was not distributed with this
        * file, You can obtain one at http://mozilla.org/MPL/2.0/.
...
declare module '__camelot-unchained/classes/Player' {
    /**
      * This Source Code Form is subject to the terms of the Mozilla Public
      * License, v. 2.0. If a copy of the MPL was not distributed with this
      * file, You can obtain one at http://mozilla.org/MPL/2.0/.
...
declare module '__camelot-unchained/classes/Character' {
    /**
      * This Source Code Form is subject to the terms of the Mozilla Public
      * License, v. 2.0. If a copy of the MPL was not distributed with this
      * file, You can obtain one at http://mozilla.org/MPL/2.0/.
      */
    import Player from '__camelot-unchained/classes/Player';
    import Inventory from '__camelot-unchained/classes/Inventory';
    import EquippedItems from '__camelot-unchained/classes/EquippedItems';
    import BaneBoon from '__camelot-unchained/classes/BaneBoon';
    import SpellBook from '__camelot-unchained/classes/SpellBook';
    import Group from '__camelot-unchained/classes/Group';
    import Stats from '__camelot-unchained/classes/Stats';
...
declare module '__camelot-unchained/classes/ControlGame' {
    /**
      * This Source Code Form is subject to the terms of the Mozilla Public
      * License, v. 2.0. If a copy of the MPL was not distributed with this
      * file, You can obtain one at http://mozilla.org/MPL/2.0/.
...
declare module '__camelot-unchained/classes/AbilityComponent' {
    /**
      * This Source Code Form is subject to the terms of the Mozilla Public
      * License, v. 2.0. If a copy of the MPL was not distributed with this
      * file, You can obtain one at http://mozilla.org/MPL/2.0/.
      */
    import abilityTags from '__camelot-unchained/constants/abilityConstants/abilityTags';
    import componentType from '__camelot-unchained/constants/abilityConstants/componentType';
    import componentPath from '__camelot-unchained/constants/abilityConstants/componentPath';
    import componentSubType from '__camelot-unchained/constants/abilityConstants/componentSubType';
    import componentBranchState from '__camelot-unchained/constants/abilityConstants/componentBranchState';
    import stats from '__camelot-unchained/classes/Stats';
...
declare module '__camelot-unchained/classes/Inventory' {
    /**
      * This Source Code Form is subject to the terms of the Mozilla Public
      * License, v. 2.0. If a copy of the MPL was not distributed with this
      * file, You can obtain one at http://mozilla.org/MPL/2.0/.
      */
    import Item from '__camelot-unchained/classes/Item';
    class Inventory {
        items: Item[];
...
declare module '__camelot-unchained/classes/EquippedItems' {
    /**
      * This Source Code Form is subject to the terms of the Mozilla Public
      * License, v. 2.0. If a copy of the MPL was not distributed with this
      * file, You can obtain one at http://mozilla.org/MPL/2.0/.
...
declare module '__camelot-unchained/classes/BaneBoon' {
    /**
      * This Source Code Form is subject to the terms of the Mozilla Public
      * License, v. 2.0. If a copy of the MPL was not distributed with this
      * file, You can obtain one at http://mozilla.org/MPL/2.0/.
      */
    import channelId from '__camelot-unchained/constants/channelId';
    import baneBoonCategory from '__camelot-unchained/constants/baneBoonCategory';
    class BaneBoon {
        id: string;
        channelId: channelId;
        name: string;
...
declare module '__camelot-unchained/classes/SpellBook' {
    /**
      * This Source Code Form is subject to the terms of the Mozilla Public
      * License, v. 2.0. If a copy of the MPL was not distributed with this
      * file, You can obtain one at http://mozilla.org/MPL/2.0/.
...
declare module '__camelot-unchained/classes/Group' {
    /**
      * This Source Code Form is subject to the terms of the Mozilla Public
      * License, v. 2.0. If a copy of the MPL was not distributed with this
      * file, You can obtain one at http://mozilla.org/MPL/2.0/.
...
declare module '__camelot-unchained/classes/Stats' {
    /**
      * This Source Code Form is subject to the terms of the Mozilla Public
      * License, v. 2.0. If a copy of the MPL was not distributed with this
      * file, You can obtain one at http//mozilla.org/MPL/2.0/.
...
declare module '__camelot-unchained/constants/abilityConstants/componentType' {
    /**
      * This Source Code Form is subject to the terms of the Mozilla Public
      * License, v. 2.0. If a copy of the MPL was not distributed with this
      * file, You can obtain one at http//mozilla.org/MPL/2.0/.
...
declare module '__camelot-unchained/constants/abilityConstants/componentPath' {
    /**
      * This Source Code Form is subject to the terms of the Mozilla Public
      * License, v. 2.0. If a copy of the MPL was not distributed with this
      * file, You can obtain one at http//mozilla.org/MPL/2.0/.
...
declare module '__camelot-unchained/constants/abilityConstants/componentSubType' {
    /**
      * This Source Code Form is subject to the terms of the Mozilla Public
      * License, v. 2.0. If a copy of the MPL was not distributed with this
      * file, You can obtain one at http//mozilla.org/MPL/2.0/.
...
declare module '__camelot-unchained/constants/abilityConstants/componentBranchState' {
    /**
      * This Source Code Form is subject to the terms of the Mozilla Public
      * License, v. 2.0. If a copy of the MPL was not distributed with this
      * file, You can obtain one at http//mozilla.org/MPL/2.0/.
...
declare module '__camelot-unchained/classes/Item' {
    /**
      * This Source Code Form is subject to the terms of the Mozilla Public
      * License, v. 2.0. If a copy of the MPL was not distributed with this
      * file, You can obtain one at http://mozilla.org/MPL/2.0/.
      */
    import itemType from '__camelot-unchained/constants/itemType';
    class Item {
        id: string;
        type: itemType;
        name: string;
...
declare module '__camelot-unchained/constants/baneBoonCategory' {
    /**
      * This Source Code Form is subject to the terms of the Mozilla Public
      * License, v. 2.0. If a copy of the MPL was not distributed with this
      * file, You can obtain one at http://mozilla.org/MPL/2.0/.
...
declare module '__camelot-unchained/constants/itemType' {
    /**
      * This Source Code Form is subject to the terms of the Mozilla Public
      * License, v. 2.0. If a copy of the MPL was not distributed with this
      * file, You can obtain one at http://mozilla.org/MPL/2.0/.
